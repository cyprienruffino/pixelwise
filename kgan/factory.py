...
def get_generator(gen):
    if gen == generators.classical_sgan:
        from kgan.generator import classical_sgan as _gen
    elif gen == generators.pix2pix_decoder:
        from kgan.generator import pix2pix_decoder as _gen
    elif gen == generators.pix2pix_encoder_decoder:
        from kgan.generator import pix2pix_encoder_decoder as _gen
    elif gen == generators.pix2pix_unet:
        from kgan.generator import pix2pix_unet as _gen
    elif gen == generators.pix2pix_patchgan:
        from kgan.generator import pix2pix_patchgan as _gen
    else:
...
def get_discriminator(disc):
    if disc == discriminators.classical_sgan:
        from kgan.discriminator import classical_sgan as _disc
    elif disc == discriminators.pix2pix_disc70x70:
        from kgan.discriminator import pix2pix_disc70x70 as _disc
    elif disc == discriminators.pix2pix_disc1x1:
        from kgan.discriminator import pix2pix_disc1x1 as _disc
    elif disc == discriminators.pix2pix_disc16x16:
        from kgan.discriminator import pix2pix_disc16x16 as _disc
    elif disc == discriminators.pix2pix_disc256x256:
        from kgan.discriminator import pix2pix_disc256x256 as _disc
    else:
...
def get_losses(loss):
    if loss == losses.classical_sgan:
        from kgan.losses import gan_true as loss_true
        from kgan.losses import gan_fake as loss_fake
        from kgan.losses import gan_gen as loss_gen
    elif loss == losses.epsilon_gan:
        from kgan.losses import epsilon_gan_true as loss_true
        from kgan.losses import epsilon_gan_fake as loss_fake
        from kgan.losses import epsilon_gan_gen as loss_gen
    elif loss == losses.wasserstein_gan:
        from kgan.losses import wasserstein_true as loss_true
        from kgan.losses import wasserstein_fake as loss_fake
        from kgan.losses import wasserstein_gen as loss_gen
    elif loss == losses.wasserstein_min_gan:
        from kgan.losses import wasserstein_min_true as loss_true
        from kgan.losses import wasserstein_min_fake as loss_fake
        from kgan.losses import wasserstein_min_gen as loss_gen
    elif loss == losses.softplus_gan:
        from kgan.losses import softplus_gan_true as loss_true
        from kgan.losses import softplus_gan_fake as loss_fake
        from kgan.losses import softplus_gan_gen as loss_gen
    else:
