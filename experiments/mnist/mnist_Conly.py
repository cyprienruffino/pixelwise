...
from applications import dcgan_mnist
...
class CustomConfig(Config):
    ...
    def __init__(self, name):
        ...
        self.constraints_provider = mnist.get_dataconst_provider
        self.constraints_provider_args = {"batch_size": self.batch_size}
        ...
        self.metrics = {
            ...
            "LBP": metrics.lbp,
            "HOG": metrics.hog,
            "FID": metrics.create_fid_func("fid_models/mnist.hdf5")
        }
