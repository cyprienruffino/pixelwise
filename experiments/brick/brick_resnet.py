...
from applications import unet_resnet as gen
from applications import disc_patchgan as disc
from datasets import from_hdf5
from utils import noise, synthetic
from losses.nonsaturating import d_fake_cond, d_real_cond, g_cond
from regularizers.mask_mse import mask_mse
...
class CustomConfig(Config):
    ...
    def __init__(self, name):
        ...
        # Losses
        self.loss_gen = g_cond
        self.loss_disc_fake = d_fake_cond
        self.loss_disc_real = d_real_cond
        self.regularizer = mask_mse
