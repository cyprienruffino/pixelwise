...
class SGAN(object):
    ...
    def _build_sgan(self):
        Z = Input((self.config.nz, None, None))
...
if __name__ == "__main__":
    ...
    # the sample for which to plot samples
    z_sample = np.random.uniform(-1., 1., (1, c.nz, c.zx_sample, c.zx_sample))
