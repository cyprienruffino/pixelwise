...
modelpath = 'keras/2D/ti2500_wnd_01_filters64_npx353_5gL_5dL_epoch16.sgan'
configpath = 'keras/2D/config.py'
...
def main_gen(DoFiltering=DoFiltering, DoThreshold=DoThreshold, nsample=1, TriCatTI=TriCatTI):
    ...
    t_start = time.time()
    np.random.seed(
        2046)  # seed is 2046 for generating the realizations in the paper, seed is 123 for generating the true model in the inversions
